...
export function LandingInstallCallout() {
	...
	return (
		<div
			aria-live='polite'
			className='mt-8 max-w-2xl rounded-[1.25rem] border border-border/80 bg-surface/90 p-4 text-foreground shadow-sm backdrop-blur-sm sm:p-5'
			role='status'>
			<div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5'>
				...
				<div className='min-w-0 flex-1'>
					...
					<p className='mt-2 text-muted-foreground text-sm leading-relaxed'>
						{variant === "browser-prompt"
							? "Add the app for faster launch and a full-screen operator experience—works great on tablets at the gate."
							: variant === "ios-safari"
