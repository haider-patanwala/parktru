...
export function PublicReceiptPage({
	...
	const amountColumnLabel = isClosedReceipt ? "Amount" : "Estimate";
	const totalLabel = isClosedReceipt ? "Total paid" : "Estimated pending";
					...
					<div className="text-neutral-500 text-xs">
						...
						<p className="mt-1">
							{isClosedReceipt
								...
								: "This is not a paid receipt. Estimated pending amount may change until exit is processed."}
						</p>
					</div>
